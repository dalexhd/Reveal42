...
var RevealBroadcast = window.RevealBroadcast || (function () {
	...
	function connect(params) {
		...
		connection.connectSocket(function (socket) {
			...
			*/
			...
			socket.on('broadcast-stopped', function (broadcastId) {
				console.warn('broadcast-stopped', broadcastId);
			});
	...
	******************************************************************/
	...
	function createPreview() {
		...
		var div = document.getElementById("screen-sharing")
		div.innerHTML = '<video id="broadcast-mediaplayer" style="width:100%;min-height: 100vh;height:100%;display: block;margin: 0 auto;pointer-events: none;" autoplay></video>';
