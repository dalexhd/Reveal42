...
export default class Keyboard {
	...
	onDocumentKeyDown(event) {
		...
		const firstSlideShortcut = event.shiftKey && keyCode === 37;
		const lastSlideShortcut = event.shiftKey && keyCode === 39;
		...
		if (this.Reveal.isPaused() && !resumeKeyCodes.includes(keyCode)) {
			return false;
		}
