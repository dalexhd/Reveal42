    ...
    if (background) {
      ...
      if (background.hasAttribute('data-loaded') === false) {
        ...
        let backgroundImage = slide.getAttribute('data-background-image'),
          ...
          backgroundVideoSubtitles = slide.getAttribute(
            'data-background-video-subtitles'
          ),
          backgroundVideoThumbnails = slide.getAttribute(
            'data-background-video-thumbnails'
          ),
          backgroundVideoVolume = slide.getAttribute(
            'data-background-video-volume'
          ),
          backgroundVideoLoop = slide.hasAttribute(
            'data-background-video-loop'
          ),
          backgroundInteractive = slide.getAttribute(
        ...
        // Videos
          ...
          if (
            ...
            (this.this.Reveal.isSpeakerNotes() &&
