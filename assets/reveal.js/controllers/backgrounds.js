...
export default class Backgrounds {
   ...
   */
  create() {
    const printMode = this.Reveal.isPrintingPDF();
  ...
  sync(slide) {
    ...
    const data = {
      ...
      backgroundIframes: slide.getAttribute("data-background-iframes"),
  ...
  updateParallax() {
    ...
    if (this.Reveal.getConfig().parallaxBackgroundImage) {
      ...
      if (
        ...
        horizontalOffsetMultiplier = this.Reveal.getConfig()
      ...
      const horizontalOffset = horizontalOffsetMultiplier * indices.h * -1;
      ...
      if (
        ...
        verticalOffsetMultiplier = this.Reveal.getConfig()
